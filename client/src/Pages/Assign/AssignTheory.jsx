...
function AssignTheory() {
  ...
  useEffect(() => {
    ...
    const fetchTeachers = async () => {
      try {
        const response = await axios.get('https://samay2.onrender.com/api/fetchteachers');
  ...
  useEffect(() => {
    const fetchAssignments = async () => {
      try {
        const response = await axios.get('https://samay2.onrender.com/api/fetchassignments');
  ...
  const handleAssign = async () => {
    try {
      await axios.post('https://samay2.onrender.com/api/theoryassignments', {
