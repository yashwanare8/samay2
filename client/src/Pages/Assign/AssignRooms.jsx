...
function AssignClassrooms() {
    ...
    useEffect(() => {
        const fetchClassrooms = async () => {
            try {
                const response = await axios.get('https://samay2.onrender.com/api/fetchclassroom');
    ...
    useEffect(() => {
        const fetchAssignments = async () => {
            try {
                const response = await axios.get('https://samay2.onrender.com/api/fetchclassrooms');
    ...
    const handleAssign = async (e) => {
        e.preventDefault();
        try {
            await axios.post('https://samay2.onrender.com/api/assignclassrooms', {
    ...
    const handleDelete = async (assignmentId) => {
        try {
            await axios.delete(`https://samay2.onrender.com/api/removeclassroom/${assignmentId}`);
