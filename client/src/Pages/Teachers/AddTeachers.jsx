...
function AddTeachers() {
      ...
      buttons: [
        {
          ...
          onClick: async () => {
            try {
              const response = await axios.delete(`https://samay2.onrender.com/api/deleteTeacher/${id}`);
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('https://samay2.onrender.com/api/teachers', formData);
