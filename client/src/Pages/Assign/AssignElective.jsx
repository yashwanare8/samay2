...
function AssignElectives() {
    ...
    useEffect(() => {
        const fetchSubjects = async () => {
            try {
                const response = await axios.get('https://samay2.onrender.com/api/fetchsubjects');
        ...
        const fetchTeachers = async () => {
            try {
                const response = await axios.get('hhttps://samay2.onrender.com/api/fetchteachers');
                console.log(response.data.data);
    ...
    useEffect(() => {
        const fetchAssignments = async () => {
            try {
                const response = await axios.get('https://samay2.onrender.com/api/fetchelective');
                console.log(response.data.data);
    ...
    const handleAssign = async () => {
        try {
            await axios.post('https://samay2.onrender.com/api/electiveassignments', {
            ...
            buttons: [
                {
                    ...
                    onClick: async () => {
                        try {
                            await axios.delete(`https://samay2.onrender.com/api/deleteAssignments/${AssignmentId}`);
