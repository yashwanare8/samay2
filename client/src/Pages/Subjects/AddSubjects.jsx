...
function AddSubjects() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('https://samay2.onrender.com/api/addsubjects', formData);
        ...
        buttons: [
          {
            ...
            onClick: async () => {
              const subjectId = id; 
              const response = await axios.delete(`https://samay2.onrender.com/api/deletesubject/${subjectId}`);
